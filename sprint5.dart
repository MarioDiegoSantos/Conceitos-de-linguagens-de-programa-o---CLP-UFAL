...
class Pagamentos {
  ...
  void pagarpix(aux) {
    (aux == true) ? num_saldo -= num_valor : num_saldo += num_valor;
    print('Nome do cliente: ${nome_cliente}');
    print('Valor do pix: ${num_valor}');
    print('Chave Pix: ${getRandomString(16)}');
    if(aux == true) print('Saldo após o pagamento pix: ${num_saldo - num_valor}');
    else print('Saldo após o deposito pix: ${num_saldo + num_valor}');
    print("****************************************");
  }
...
void deposito(Pagamentos cliente)
{
  ...
  if(pagamento == 1){
    ...
    switch(escolha){
      case 1: cliente.pagarpix(aux); break;
      case 2: cliente.pagarted(); break;
      case 3: cliente.gerarboleto(time,l,cliente.valor); break;
    }
  }
    ...
    switch(escolha){
     case 1: cliente.pagarpix(aux); break;
     case 2: cliente.pagarted(); break;
     case 3: cliente.gerarboleto(0,l,cliente.valor); break;
    }
  }
}
...
void pagamento(Pagamentos cliente)
{
  ...
  if(escolha_pagamento == 1){ 
    ...
    if(escolha == 1){
      ...
      if(cliente.num_saldo - cliente.num_valor < -100) print("Saldo insuficiente!, seu saldo após o pagamento ultrapassa o limite de -100!");
